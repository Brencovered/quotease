      ...
      <header className="bg-[var(--navy)] px-5 py-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <nav className="flex items-center gap-5 text-[13px] font-semibold">
            ...
            <Link href="/admin/activity" className="text-[var(--steel-1)] hover:text-white">Activity</Link>
            <Link href="/admin/analytics" className="text-[var(--steel-1)] hover:text-white">Analytics</Link>
