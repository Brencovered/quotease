...
export default async function DirectoryPage({
  ...
  return (
    <main className="min-h-screen" style={{ background: "var(--app-bg)" }}>
      {/* ── Inline keyframes for gradient orbs ── */}
      <style>{`
      ...
      <section className="relative overflow-hidden bg-[#0a1722]">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(255,180,0,0.22) 0%, transparent 65%)",
            top: "-15%",
            left: "-8%",
        ...
        <div className="relative max-w-6xl mx-auto px-6 pt-16 pb-20 sm:pt-20 sm:pb-24">
          ...
          <div className="reveal flex items-center gap-2 mb-5">
            ...
            <span
              className="text-[11px] font-bold tracking-[.2em] uppercase"
              style={{ color: "#ffb400" }}
            >
          ...
          {/* Subheadline */}
          <p
            className="reveal text-[15px] sm:text-[16px] max-w-xl mb-10 leading-relaxed"
            style={{ color: "#8b96a1" }}
          >
            Every business is verified with real Google reviews. Browse 196+
            verified tradies across Melbourne&apos;s south east, or post your
            job and get up to 3 quotes.
          </p>
          ...
          <div className="reveal flex flex-wrap gap-4 sm:gap-6 mb-12">
            {[
              ...
              <div
                ...
                style={{ color: "#8b96a1" }}
              >
                <Icon size={14} style={{ color: "#ffb400" }} />
                {text}
              </div>
            ))}
          </div>
          ...
          <div className="reveal flex flex-wrap gap-3">
            <Link
              href="/get-quotes"
              className="inline-flex items-center gap-2 bg-[#ffb400] text-[#0a1722] font-extrabold text-[14px] px-7 py-3.5 rounded-xl hover:bg-[#e89e00] transition-colors"
            >
              Get quotes <ArrowRight size={15} />
            </Link>
            <Link
              href="#listings"
              className="inline-flex items-center gap-2 text-white font-bold text-[14px] px-7 py-3.5 rounded-xl border border-white/25 hover:border-white/50 hover:bg-white/5 transition-all"
            >
              Browse directory
            </Link>
          </div>
      ...
      <section className="bg-white border-b" style={{ borderColor: "var(--line)" }}>
        <div className="max-w-6xl mx-auto px-6 py-16 sm:py-20">
          <div className="text-center mb-12">
            <h2
              className="font-display text-[1.8rem] sm:text-[2.2rem] mb-3"
              style={{ color: "var(--ink)" }}
            >
            ...
            {[
              {
                ...
                icon: ClipboardList,
                title: "Post your job",
                desc: "Describe what you need done, your suburb, and any budget or timing preferences.",
              },
              {
                num: "02",
                icon: MessageSquare,
                title: "Get up to 3 quotes",
                desc: "Matched local tradies review your job and respond with detailed quotes.",
              },
              {
                num: "03",
                icon: Award,
                title: "Hire with confidence",
                desc: "Compare ratings, read real reviews, and choose the right tradie for you.",
              },
            ].map(({ num, icon: Icon, title, desc }, i) => (
              <div
                key={num}
                className="reveal group relative p-6 sm:p-8 rounded-2xl border text-center transition-all duration-200 hover:-translate-y-1 hover:shadow-lg"
                style={{
              ...
              >
                {/* Number badge */}
                <div
                  className="absolute -top-3 left-1/2 -translate-x-1/2 text-[11px] font-extrabold px-3 py-1 rounded-full border"
                  style={{
      ...
      >
        <form
          method="GET"
          className="max-w-6xl mx-auto px-6 py-3 flex flex-wrap gap-2 items-center"
        >
          <select
            name="trade"
            defaultValue={trade ?? ""}
          ...
          <button
            type="submit"
            className="bg-[#0a1722] text-white font-bold text-[13px] px-5 py-2.5 rounded-xl hover:opacity-90 transition-opacity"
          >
            Search
          </button>
          {(trade || suburb) && (
          ...
          <span
            className="text-[12px] ml-auto hidden sm:block"
            style={{ color: "var(--ink-faint)" }}
          >
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        {error && (
          <div
            className="text-[13px] px-4 py-3 rounded-xl mb-6 font-semibold"
            style={{
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          <Link
            href={`/directory${suburb ? `?suburb=${suburb}` : ""}`}
            className={`px-3.5 py-1.5 rounded-full text-[12.5px] font-semibold border transition-colors ${
              !trade
                ? "bg-[#0a1722] text-white border-[#0a1722]"
                : "bg-white hover:border-[#8b96a1]"
            }`}
            style={
              trade
        ...
        {!listings?.length ? (
          ...
          >
            <p className="text-[32px] mb-3">
              <Search size={32} className="mx-auto" style={{ color: "var(--ink-faint)" }} />
            </p>
            <p
            ...
            <Link
              href="/directory"
              className="px-5 py-2.5 border rounded-xl text-[13.5px] font-semibold inline-flex transition-colors hover:opacity-80"
              style={{
                borderColor: "var(--line)",
                color: "var(--ink-soft)",
              }}
          ...
          <div className="flex items-center justify-center gap-2 mt-10">
            {page > 1 && (
              <Link
                ...
                className="px-4 py-2 border rounded-xl text-[13px] font-semibold transition-colors hover:opacity-80"
                style={{
                  borderColor: "var(--line)",
                  color: "var(--ink-soft)",
                  background: "var(--surface)",
        ...
        <section className="mt-20 sm:mt-24">
          <div className="text-center mb-10">
            ...
            <p
              ...
              style={{ color: "var(--ink-soft)" }}
            >
              Real stories from homeowners who found their tradie through
              Swiftscope.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-3 gap-5">
            {HOMEOWNER_REVIEWS.map((review, i) => (
              <div
                key={review.name}
                className="reveal p-6 rounded-2xl border transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
                style={{
                  background: "var(--surface)",
                  borderColor: "var(--line)",
                  animationDelay: `${i * 100}ms`,
              ...
              >
                ...
                {/* Quote */}
                <p
                  className="text-[13.5px] leading-relaxed mb-5 italic"
                  style={{ color: "var(--ink-soft)" }}
                >
                ...
                <div className="flex items-center gap-3 pt-4 border-t" style={{ borderColor: "var(--line-subtle)" }}>
                  ...
                  <div>
                    ...
                    <p
                      ...
                      style={{ color: "var(--ink-faint)" }}
                    >
                      {review.suburb} &middot; Hired a {review.trade}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mt-20 sm:mt-24">
          ...
          >
            ...
            <div className="relative">
              <h2 className="font-display text-[2rem] sm:text-[2.6rem] text-white mb-3">
                Ready to find the right tradie?
              </h2>
              <p
                className="text-[14px] sm:text-[15px] max-w-lg mx-auto mb-8"
                style={{ color: "#8b96a1" }}
              >
                Post your job for free and get up to 3 quotes from verified
                local tradies. No obligation, no spam.
              </p>
              <div className="flex flex-wrap justify-center gap-3">
                <Link
                  href="/get-quotes"
                  className="inline-flex items-center gap-2 bg-[#ffb400] text-[#0a1722] font-extrabold text-[14px] px-8 py-3.5 rounded-xl hover:bg-[#e89e00] transition-colors"
                >
                  Get quotes <ArrowRight size={15} />
                </Link>
                <Link
                  href="/signup"
                  className="inline-flex items-center gap-2 text-white font-bold text-[14px] px-8 py-3.5 rounded-xl border border-white/25 hover:border-white/50 hover:bg-white/5 transition-all"
                >
                  List your business
                </Link>
              </div>
