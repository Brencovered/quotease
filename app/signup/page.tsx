          ...
          {checkEmail ? (
            ...
            <>
              <div className="bg-[var(--surface)] border border-[var(--line)] rounded-2xl p-8 shadow-sm">
                ...
                <p className="text-[13.5px] text-[var(--ink-faint)] mb-6">$39/month after your free trial. No credit card needed to start.</p>
              ...
              <p className="text-center text-[12px] text-[var(--ink-faint)] mt-4">
                $39/month · unlimited seats · cancel any time
              </p>
            </>
          )}
        </div>
