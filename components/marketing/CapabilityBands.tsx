...
const BANDS: Band[] = [
  {
    ...
    photoAlt: "Tradie on site quoting from their phone",
    photoPos: "object-[40%_center]",
  ...
  },
  {
    ...
    photoAlt: "Tradies on a residential house construction site",
  ...
  },
  {
    ...
    photoAlt: "Workers on a residential interior construction site",
