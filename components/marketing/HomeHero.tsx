...
const SCENES: Scene[] = [
  {
    ...
    alt: "Tradie on site quoting from their phone",
    overlay: "quote",
    label: "Quote",
  ...
  },
  {
    ...
    alt: "Tradies arriving on a residential house construction site",
    overlay: "win",
    label: "Win",
  ...
  },
  {
    ...
    alt: "Workers on a residential interior construction site",
    overlay: "manage",
    label: "Manage",
