...
export const FEATURES_GRID: FeatureGridItem[] = [
  {
    ...
    note: "Free directory listing with Google ratings. Homeowners find you and contact you direct. No per-lead auction.",
    image: "/marketing/lead-generation-leads.png",
    imageAlt: "Swiftscope directory and local enquiry flow for tradies",
    heroTitle: "Get found locally without the auction",
    heroSubtitle: "Directory listing included. Homeowners contact you direct.",
    valueStatement: "A free listing in your service area with real Google ratings, so homeowners can find you and reach out without you buying leads one at a time.",
    replacesReason: "HiPages charges $30-150 every time you claim a lead. Swiftscope includes your directory listing in the flat plan, with no auction and no credits.",
    quickStats: ["No auction", "No credits system", "Listing included"],
    intro: [
      "Most lead marketplaces sell you the same job over and over, then take a cut every time you claim it. **That puts pressure on the price before you have even scoped the work.**",
      "Swiftscope takes a different path. **Your directory listing is included**, with real Google ratings, so homeowners in your suburbs can find you, check you out, and contact you direct.",
      "When someone reaches out from your listing, they already chose you. That is warmer than an anonymous job post sitting in a bidding war. Quote from your phone, win the job, and keep running the work in the same app.",
    ],
    workflow: [
      { step: 1, title: "Claim your listing", body: "Claim or create your business page, add your trades and suburbs, and keep your contact details current." },
      { step: 2, title: "Homeowners browse locally", body: "People searching by trade and suburb see your listing with real Google ratings, not a paid auction slot." },
      { step: 3, title: "They contact you direct", body: "Call, email, website, or a quote request on your page. No middleman deciding who gets the job." },
      { step: 4, title: "Quote on site, win the job", body: "Use the mobile quote builder to send a professional quote before you leave the driveway. Same-day quotes win more often." },
    ],
    whySwiftscope: [
      "HiPages, Oneflare and Airtasker mostly sell access to jobs. Swiftscope includes discovery in the same product you already use to quote and run work, so you are not paying a second platform just to be found.",
      "Because the monthly fee is flat, you are not calculating whether a lead is worth $80 before you even visit site. You show up where homeowners already look, then win on speed and clarity of quote.",
      "Listings with real Google ratings beat anonymous marketplace cards. People can see who you are before they reach out.",
    ],
    bullets: [
      "Free directory listing included with your plan",
      ...
      "Quote requests on claimed pages feed into your workflow",
  ...
  },
  {
    ...
    type: "integrate",
    replaces: "Xero",
    label: "Xero invoice push",
    note: "Connect Xero once. When a quote is accepted, Swiftscope pushes a draft invoice so you are not re-typing totals.",
    ...
    heroSubtitle: "Accepted quotes push into Xero as draft invoices",
    valueStatement: "An accepted quote becomes a draft invoice in Xero, so your books start from the numbers you actually quoted - without copying them by hand.",
    replacesReason: "Every competitor offers some form of Xero sync. Swiftscope includes OAuth invoice push on the base plan, not a higher tier.",
    quickStats: ["Live OAuth connect", "Draft invoice on accept", "Included, not an add-on"],
    intro: [
    ...
    workflow: [
      { step: 1, title: "Connect Xero once", body: "Go to Settings and connect your Xero account via OAuth. Takes about 60 seconds." },
      { step: 2, title: "Quote is accepted by the client", body: "When the client taps Accept on their quote, Swiftscope creates the job and queues a draft invoice for Xero." },
      { step: 3, title: "Draft invoice appears in Xero", body: "The invoice lands in Xero as a draft with client details, reference, and line items from the quote scope when available. You approve it in Xero." },
      { step: 4, title: "Review before sending", body: "Check tax codes and account mapping in Xero - Swiftscope does not pull your full chart of accounts or rewrite invoices after variations yet." },
      { step: 5, title: "Mark paid where you work", body: "Record payment in Xero as usual, then mark the job paid in Swiftscope when you want the jobs board to match. Payment does not auto-flow back yet." },
    ],
    whySwiftscope: [
