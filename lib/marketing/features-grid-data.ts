...
export const FEATURES_GRID: FeatureGridItem[] = [
  ...
  },
  {
    ...
    heroImageAlt: "Swiftscope quote builder job step showing job and ceiling type, call-out fee, customer pricing tier, job size, hourly rate and effective margin",
  ...
  },
  {
    ...
    heroImage: "/product/pricing-tiers.webp",
    heroImageAlt: "Customer pricing tiers screen showing four tiers including residential at six percent markup and sub contracting at fifteen percent",
