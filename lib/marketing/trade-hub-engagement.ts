...
export const TRADE_ENGAGEMENT: Record<string, TradeEngagement> = {
  ...
  painter: {
    ...
    quoteFields: [
      { id: "rooms", label: "Rooms", mockLine: "Bedroom walls (3 coats)", mockQty: "1 room", mockAmount: 680 },
      { id: "prep", label: "Prep level", mockLine: "Fill, sand & spot prime", mockQty: "1 lot", mockAmount: 220 },
      { id: "coats", label: "Coat count", mockLine: "Two topcoats + primer", mockQty: "included", mockAmount: 0 },
      { id: "materials", label: "Materials", mockLine: "Wash & Wear low sheen", mockQty: "10 L", mockAmount: 180 },
      { id: "labour", label: "Labour hours", mockLine: "Painting labour", mockQty: "8 h", mockAmount: 720 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  tiler: {
    ...
    quoteFields: [
      { id: "area", label: "Area m²", mockLine: "Floor tile area", mockQty: "6.2 m²", mockAmount: 279 },
      { id: "supply", label: "Tile supply", mockLine: "300×600 porcelain", mockQty: "7.2 m²", mockAmount: 324 },
      { id: "waterproof", label: "Waterproofing", mockLine: "Wet-area membrane", mockQty: "1 lot", mockAmount: 380 },
      { id: "trim", label: "Trim", mockLine: "Schluter / tile trim", mockQty: "8 m", mockAmount: 96 },
      { id: "labour", label: "Labour hours", mockLine: "Tiling labour", mockQty: "10 h", mockAmount: 1100 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  landscaper: {
    ...
    quoteFields: [
      { id: "soft", label: "Softscape", mockLine: "Planting package", mockQty: "1 lot", mockAmount: 860 },
      { id: "hard", label: "Hardscape", mockLine: "Paving & edging", mockQty: "18 m²", mockAmount: 990 },
      { id: "materials", label: "Materials", mockLine: "Mulch & soil", mockQty: "1 lot", mockAmount: 240 },
      { id: "hire", label: "Machine hire", mockLine: "Mini excavator day", mockQty: "1 day", mockAmount: 450 },
      { id: "labour", label: "Labour days", mockLine: "Landscaping labour", mockQty: "2 days", mockAmount: 1600 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  arborist: {
    ...
    quoteFields: [
      { id: "trees", label: "Tree count", mockLine: "Mature eucalypt remove", mockQty: "1 ea", mockAmount: 1800 },
      { id: "access", label: "Access", mockLine: "Restricted side access", mockQty: "1 lot", mockAmount: 150 },
      { id: "crew", label: "Crew size", mockLine: "3-person climbing crew", mockQty: "1 day", mockAmount: 1400 },
      { id: "disposal", label: "Disposal", mockLine: "Green waste tip fees", mockQty: "1 lot", mockAmount: 180 },
      { id: "stump", label: "Stump work", mockLine: "Stump grind", mockQty: "1 ea", mockAmount: 220 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  concreter: {
    ...
    quoteFields: [
      { id: "area", label: "Area m²", mockLine: "Path / slab area", mockQty: "24 m²", mockAmount: 0 },
      { id: "thickness", label: "Thickness", mockLine: "100 mm slab", mockQty: "specified", mockAmount: 0 },
      { id: "steel", label: "Steel / mesh", mockLine: "SL72 mesh + chairs", mockQty: "1 lot", mockAmount: 260 },
      { id: "pump", label: "Pump hire", mockLine: "Concrete pump", mockQty: "1 ea", mockAmount: 380 },
      { id: "labour", label: "Labour", mockLine: "Form, pour & finish", mockQty: "10 h", mockAmount: 1100 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  fencer: {
    ...
    quoteFields: [
      { id: "length", label: "Length m", mockLine: "Boundary fence run", mockQty: "24 m", mockAmount: 1440 },
      { id: "posts", label: "Post count", mockLine: "Intermediate posts", mockQty: "13 ea", mockAmount: 455 },
      { id: "panels", label: "Panels", mockLine: "ColorBond panels", mockQty: "24 m", mockAmount: 0 },
      { id: "gates", label: "Gates", mockLine: "Single pedestrian gate", mockQty: "1 ea", mockAmount: 420 },
      { id: "removal", label: "Removal", mockLine: "Old fence pull-down", mockQty: "1 lot", mockAmount: 280 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  aircon: {
    ...
    quoteFields: [
      { id: "system", label: "System type", mockLine: "Wall split 2.5 kW", mockQty: "1 ea", mockAmount: 980 },
      { id: "heads", label: "Heads", mockLine: "Indoor heads", mockQty: "1 ea", mockAmount: 0 },
      { id: "mounts", label: "Mounts / pipe", mockLine: "Pipe set & brackets", mockQty: "1 lot", mockAmount: 220 },
      { id: "electrical", label: "Electrical", mockLine: "Isolator & circuit", mockQty: "1 lot", mockAmount: 180 },
      { id: "labour", label: "Labour", mockLine: "Install & commission", mockQty: "4 h", mockAmount: 440 },
      { id: "margin", label: "Margin", mockLine: "Residential margin (+6%)", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  surveyor: {
    ...
    quoteFields: [
      { id: "visit", label: "Site visit", mockLine: "Survey site attendance", mockQty: "1 ea", mockAmount: 650 },
      { id: "deliverable", label: "Deliverable", mockLine: "Identification survey plan", mockQty: "1 ea", mockAmount: 420 },
      { id: "drafting", label: "Drafting", mockLine: "CAD drafting", mockQty: "1 lot", mockAmount: 380 },
      { id: "travel", label: "Travel", mockLine: "Travel / km", mockQty: "1 lot", mockAmount: 85 },
      { id: "rush", label: "Rush fee", mockLine: "48-hour turnaround", mockQty: "optional", mockAmount: 200 },
      { id: "margin", label: "Margin", mockLine: "Professional margin", mockQty: "applied", mockAmount: 0 },
    ],
  },
  ...
  custom: {
    ...
    quoteFields: [
      { id: "labour", label: "Labour", mockLine: "Trade labour", mockQty: "4 h", mockAmount: 440 },
      { id: "materials", label: "Materials", mockLine: "Materials from your book", mockQty: "1 lot", mockAmount: 210 },
      { id: "callout", label: "Call-out", mockLine: "Service call-out", mockQty: "1 ea", mockAmount: 120 },
      { id: "travel", label: "Travel", mockLine: "Travel allowance", mockQty: "1 lot", mockAmount: 45 },
      { id: "notes", label: "Notes", mockLine: "Job notes / certs", mockQty: "included", mockAmount: 0 },
      { id: "margin", label: "Margin", mockLine: "Your margin tier", mockQty: "applied", mockAmount: 0 },
    ],
  },
};
