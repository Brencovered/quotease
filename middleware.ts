...
function addSecurityHeaders(response: NextResponse): NextResponse {
  ...
  const csp = [
    ...
    "font-src 'self'",
    "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.openai.com https://api.anthropic.com https://www.google-analytics.com https://analytics.google.com https://www.google.com https://stats.g.doubleclick.net https://region1.google-analytics.com https://api.stripe.com https://api.xero.com https://identity.xero.com",
    "manifest-src 'self'",
